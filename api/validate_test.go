...
func TestValidateSeries(t *testing.T) {
	...
	cases := []struct {
		...
		{"valid rating", Series{Title: "x", Rating: 4}, ""},
		...
		{"rating too high", Series{Title: "x", Rating: 6}, "rating must be between 0 and 5"},
		{"rating negative", Series{Title: "x", Rating: -1}, "rating must be between 0 and 5"},
