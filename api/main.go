...
func main() {
	...
	mux.HandleFunc("/api/series/image", cors(requireAuth(handleListImage("series", "tv", seriesBroker))))
	mux.HandleFunc("/api/activities", cors(requireAuth(handleActivities)))
	mux.HandleFunc("/api/movies", cors(requireAuth(handleMovies)))
	mux.HandleFunc("/api/movies/image", cors(requireAuth(handleListImage("movies", "movie", moviesBroker))))
